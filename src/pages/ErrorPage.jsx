                    ...
                    <div className='flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto'>
                        ...
                        >
                            <svg
                                ...
                                strokeWidth='1.5'
                                stroke='currentColor'
                                className='w-5 h-5 rtl:rotate-180 text-primary-color'
                            >
                                <path
                                    strokeLinecap='round'
                                    strokeLinejoin='round'
                        ...
                        <div className="">
                            <Link to='/' className="btn bg-primary-color border-0 px-5 text-white hover:bg-white hover:text-primary-color">Home</Link>
                        </div>
