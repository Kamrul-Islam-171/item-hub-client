        ...
        <div className="fixed w-full z-50 top-0">
            ...
            <div className="navbar bg-base-100">
                <div className="navbar-start">
                    ...
                    <Link onClick={scrollToTop} to={'/'} className="  w-[60px] h-[50px] "><img className="w-full h-full" src={'/item-logo.png'} alt="" /></Link>
                    <Link onClick={scrollToTop} to={'/'} className=" font-bold text-lg md:text-xl lg:text-2xl flex gap-0 ">Item<span className="text-primary-color">Hub</span></Link>
                </div>
                        ...
                        user ?
                            ...
                            <>
                                <div onClick={scrollToTop} className=''>
                                    <Link to='/login' className="btn bg-teal-500 hover:bg-teal-800 text-white font-medium  border-none px-4">LogIn</Link>
                                    


                                </div>
                                <div onClick={scrollToTop} className=''>
                                    <Link to='/register' className="btn bg-teal-500 hover:bg-teal-800 text-white font-medium  border-none px-4">Register</Link>
                                </div>
                            </>
                    }
                    <div >
